...
addPrintTarget(
  'pages/EFatura.tsx',
  '<div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 sm:p-6 shadow-2xl backdrop-blur-sm print:bg-white print:p-0 print:m-0 animate-fade-in print:block">',
  '<div className="print-target fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 sm:p-6 shadow-2xl backdrop-blur-sm print:bg-white print:p-0 print:m-0 animate-fade-in print:block print:relative print:h-auto print:overflow-visible">'
);
